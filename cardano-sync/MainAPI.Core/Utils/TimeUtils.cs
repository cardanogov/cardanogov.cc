...
public static class TimeUtils
{
    ...
    /// <summary>
    /// Calculate the number of seconds from a specified number of years
    /// </summary>
    /// <param name="years">The number of years to convert to seconds</param>
    /// <returns>Seconds equivalent to the specified years</returns>
    public static int GetSecondsFromYears(int years)
    {
        return years * 365 * 24 * 60 * 60; // 365 days * 24 hours * 60 minutes * 60 seconds
    }
}